const language = {
   ...
   error4: "ПРЕДУПРЕЖДЕНИЕ: Кажется, вы не ввели ссылку Mongodb. Если не введёте действительный ссылку Mongodb в config.js, вы не сможете использовать этого бота.",
